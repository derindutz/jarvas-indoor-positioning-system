...
setInterval(function() {
  request
    .get('jarvas-api.herokuapp.com/location')
    .end(function(err, res) {
      var newLocation = res.body.location;
      var x = newLocation[0], y = newLocation[1];
...
},{"chartist":2,"superagent":4}],2:[function(require,module,exports){
...
},{"./is-function":5,"./is-object":6,"./request-base":7,"emitter":3}],5:[function(require,module,exports){
/**
